namespace Aiv.Fast2D.Utils.TextureHelper
{
	public static class TextureHelper
    {
        ...
        /// </summary>
        /// <param name="sourceFileName">Name of the Texture it has to be Decompressed</param>
        ...
        /// <param name="recursiveCheck">iA recursive loop checking through all sub directories</param>
        public static void GenerateDecompressedTexturesFromFolder(string targetDirectory, string newDirectoryName, string targetExtensionName = "txt", bool recursiveCheck = false)
        {
            ...
            foreach (string subdirectory in subDir)
                GenerateDecompressedTexturesFromFolder(subdirectory, newDirectoryName, targetExtensionName, recursiveCheck);
        }
